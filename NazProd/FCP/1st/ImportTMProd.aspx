<%@ Page Title="Import Full Case Pick 1st Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            ...
            <li>
                <asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/FCP/1st/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;"
...
<p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        <h2>
            Import Full Case Pick 1st Shift Productivity</h2>
