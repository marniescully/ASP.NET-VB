<%@ Page Title="Full Case Pick Functions" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="EditFunct.aspx.vb" Inherits="FCP_EditFCPFunct" %>
...
<asp:Panel ID="SideNavigation" runat="server" >
 ...
 <h3>Shifts</h3>
    ...
    <div id="LeftColumn" > 
<h2><asp:Label ID="FunctionLabel" runat="server" Text="Full Case Pick Functions"></asp:Label></h2>

    <asp:GridView ID="FCPFunct" runat="server" AllowSorting="True" 
        AutoGenerateColumns="False" DataKeyNames="Function" DataSourceID="FCPFunctions">
...
<asp:DetailsView ID="EditFunct" runat="server" AutoGenerateRows="False" 
 ...
 <asp:SqlDataSource ID="FCPFunctions" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT [Function], [Rate], [Description] FROM [Functions] WHERE Functions.Department = 2 ORDER BY [Function]"  >
     ...
     <asp:SqlDataSource ID="EditFunctDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
            SelectCommand="SELECT [Function], [Rate], [Description] FROM [Functions] WHERE ([Function] = ?) AND Functions.Department = 2" UpdateCommand="UPDATE [Functions] SET [Rate] = ?, [Description] = ? WHERE [Function] = ? AND Functions.Department = 2">
          
            <SelectParameters>
                <asp:ControlParameter ControlID="FCPFunct" Name="?" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
