<%@ Page Title="Shipping Functions" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="EditFunct.aspx.vb" Inherits="SHIP_EditSHIPFunct" %>
...
<asp:Panel ID="SideNavigation" runat="server" >
 ...
 <h3>Shifts</h3>
    ...
    <div id="LeftColumn" > 
<h2><asp:Label ID="FunctionLabel" runat="server" Text="Shipping Functions"></asp:Label></h2>

    <asp:GridView ID="SHIPFunct" runat="server" AllowSorting="True" 
        AutoGenerateColumns="False" DataKeyNames="Function" DataSourceID="SHIPFunctions">
...
<asp:DetailsView ID="EditFunct" runat="server" AutoGenerateRows="False" 
 ...
 <asp:SqlDataSource ID="SHIPFunctions" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT [Function], [Rate], [Description] FROM [Functions] WHERE Functions.Department = 4 ORDER BY [Function]"  >
     ...
     <asp:SqlDataSource ID="EditFunctDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
            SelectCommand="SELECT [Function], [Rate], [Description] FROM [Functions] WHERE ([Function] = ?) AND Functions.Department = 4" UpdateCommand="UPDATE [Functions] SET [Rate] = ?, [Description] = ? WHERE [Function] = ? AND Functions.Department = 4">
          
            <SelectParameters>
                <asp:ControlParameter ControlID="SHIPFunct" Name="?" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
