<%@ Page Title="Import Full Case Pick 2nd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            ...
            <li>
                <asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/FCP/2nd/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;"
   ...
   <p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        ...
        <h2>
            Import Full Case Pick 2nd Shift Productivity</h2>

      <div id="Search">
        <asp:Label ID="LblDate" runat="server">Select Date &nbsp;</asp:Label><asp:TextBox
        ...
        <asp:ValidationSummary ID="ValidationSummary" runat="server" />
         <p> <asp:Label ID="SuccessLabel" runat="server" Text=""></asp:Label></p>
    </div>
