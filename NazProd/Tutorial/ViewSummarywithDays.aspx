<%@ Page Title="How to View Productivity Summary by Date Range" Language="VB" MasterPageFile="~/Site.Master"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2>
        How to View Productivity Summary by Date Range</h2>
    <div class="Tutorial" id="LeftColumn">
        <p>
            This Report totals the amounts for each function for the dates selected.</p>
        <ol>
            <li >From your department's shift page click <span class="StrongEmphasis">
                Summary of Date Range</span> from the Reports list
                <br />
                <img alt="Click Summary of Date Range" src="images/ClickSummDate.jpg" />
            </li>
            <li>Choose a function to view or keep the selected "All" to
                view all functions<br />
                <img  alt="Choose a function" src="images/SelectFunctSummDate.jpg" />
            </li>
            <li >Choose the start date that you'd like to view by clicking
                ...
                <img alt="Choose Start Date" src="images/ChooseSummDatestart.jpg" />
            </li>
            <li >The end date is automatically the same date as the start
                ...
                <img alt="Choose End Date" src="images/ChooseSummDateend.jpg" />
            </li>
            ...
            <li>The report based on your choices is displayed.
                <br />
                <img  alt="Summ by Date Range Report" src="images/SummDateRangeReport.jpg" />
            </li>
