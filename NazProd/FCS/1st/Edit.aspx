<%@ Page Title="Edit Full Case Stock 1st Shift Productivity" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="FCS_1st_Add" %>
...
<div id="sideNav">
 ...
 <h3>Tasks</h3>
    ...
    <h3>Reports</h3>
        <ul>   
    <li><asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/FCS/1st/ViewbyTM.aspx" onmouseover="window.status='View By Team Member';return true;" onmouseout ="window.status=''; return true;">View by Team Member</asp:HyperLink> </li>
    ...
    <li><asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/FCS/1st/SummDateRange.aspx" onmouseover="window.status='Summary of Date Range';return true;" onmouseout ="window.status=''; return true;">Summary of Date Range</asp:HyperLink> </li>
     <li><asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/FCS/1st/SummbyFunct.aspx" onmouseover="window.status='Summary by Function';return true;" onmouseout ="window.status=''; return true;" CausesValidation="false">Summary by Function</asp:LinkButton> 
    ...
    <div id="Form" class="Form">
        <div id="HeadDate">
            <h2>
                <asp:Label ID="EditLabel" runat="server" Text="Edit Full Case Stock 1st Shift Productivity"></asp:Label></h2>
...
FROM TMs WHERE (((TMs.DepartmentID)=3) AND ((TMs.ShiftID)=1)) ORDER BY TMS.LastName"></asp:SqlDataSource>
