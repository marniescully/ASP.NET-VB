...
Partial Class ImportTM
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        Dim sqlStrLastDate = "SELECT Max(Prod.DTE) AS MaxOfDTE FROM PROD WHERE (((Prod.Department)=2) AND ((Prod.Shift)=1))"
    ...
    Private Sub ImportFCPMTV()
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrMTV = "INSERT INTO PROD ( DTE, M, D, Y, EmployeeID, Amount, Department, Shift, Function ) SELECT DateValue([M] & '/' & [D] & '/' & [Y]) AS [Date], Mid([FCP-MTVImportTempTable].[PROCESS_CYCLE_DTE],4,2) AS M, RIGHT([FCP-MTVImportTempTable].[PROCESS_CYCLE_DTE],2) AS D, Mid([FCP-MTVImportTempTable].[PROCESS_CYCLE_DTE],2,2) AS Y, FCP-MTVImportTempTable.USER_STAMP, FCP-MTVImportTempTable.CountOfOUTBOUND_CASE_SCAN_ID_ATR, 2 AS Department, 1 AS Shift, FCP-MTVImportTempTable.DISTRIBUTION_CENTER_NBR FROM TMs INNER JOIN FCP-MTVImportTempTable ON TMs.EmployeeID = FCP-MTVImportTempTable.USER_STAMP WHERE (((TMs.DepartmentID)=2) AND ((TMs.ShiftID)=1)) ORDER BY FCP-MTVImportTempTable.USER_STAMP"
    ...
    Private Sub ImportFCP()
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrImportFCP = "SELECT DIPDLIB.DI842P.PROCESS_CYCLE_DATE, DIPDLIB.DI842P.ACTUAL_PICKER_ID, Count(DIPDLIB.DI842P.CASE_SCAN_ID_ATR) AS CountOfCASE_SCAN_ID_ATR FROM DIPDLIB.DI210P INNER JOIN DIPDLIB.DI842P ON (DIPDLIB.DI210P.TIER = DIPDLIB.DI842P.TIER_ATR) AND (DIPDLIB.DI210P.SECTION_CDE = DIPDLIB.DI842P.SECTION_ATR) AND (DIPDLIB.DI210P.AISLE = DIPDLIB.DI842P.AISLE_ATR) WHERE (((DIPDLIB.DI842P.ACTUAL_PICKER_ID)<>' ') AND ((DIPDLIB.DI210P.AREA_CLASS_ID)<>'TR')) GROUP BY DIPDLIB.DI842P.PROCESS_CYCLE_DATE, DIPDLIB.DI842P.ACTUAL_PICKER_ID HAVING (((DIPDLIB.DI842P.PROCESS_CYCLE_DATE)=?) AND ((DIPDLIB.DI842P.ACTUAL_PICKER_ID) Like 'B%')) ORDER BY DIPDLIB.DI842P.ACTUAL_PICKER_ID"
    ...
    Private Sub ImportEW()
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrImportEW = "SELECT DIPDLIB.DI842P.PROCESS_CYCLE_DATE, DIPDLIB.DI842P.ACTUAL_PICKER_ID, Count(DIPDLIB.DI842P.CASE_SCAN_ID_ATR) AS CountOfCASE_SCAN_ID_ATR FROM DIPDLIB.DI210P INNER JOIN DIPDLIB.DI842P ON (DIPDLIB.DI210P.TIER = DIPDLIB.DI842P.TIER_ATR) AND (DIPDLIB.DI210P.SECTION_CDE = DIPDLIB.DI842P.SECTION_ATR) AND (DIPDLIB.DI210P.AISLE = DIPDLIB.DI842P.AISLE_ATR) WHERE (((DIPDLIB.DI842P.WAVE_NUMBER)>=19) AND ((DIPDLIB.DI842P.ACTUAL_PICKER_ID)<>' ') AND ((DIPDLIB.DI210P.AREA_CLASS_ID)<>'TR')) GROUP BY DIPDLIB.DI842P.PROCESS_CYCLE_DATE, DIPDLIB.DI842P.ACTUAL_PICKER_ID HAVING (((DIPDLIB.DI842P.PROCESS_CYCLE_DATE)=?) AND ((DIPDLIB.DI842P.ACTUAL_PICKER_ID) Like 'B%')) ORDER BY DIPDLIB.DI842P.ACTUAL_PICKER_ID"
    ...
    Private Sub ImportTR()
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrImportTR = "SELECT DIPDLIB.DI842P.PROCESS_CYCLE_DATE, DIPDLIB.DI842P.ACTUAL_PICKER_ID, Count(DIPDLIB.DI842P.CASE_SCAN_ID_ATR) AS CountOfCASE_SCAN_ID_ATR, DIPDLIB.DI210P.AREA_CLASS_ID FROM DIPDLIB.DI210P INNER JOIN DIPDLIB.DI842P ON (DIPDLIB.DI210P.TIER = DIPDLIB.DI842P.TIER_ATR) AND (DIPDLIB.DI210P.SECTION_CDE = DIPDLIB.DI842P.SECTION_ATR) AND (DIPDLIB.DI210P.AISLE = DIPDLIB.DI842P.AISLE_ATR) WHERE (((DIPDLIB.DI842P.ACTUAL_PICKER_ID)<>' ') AND ((DIPDLIB.DI210P.AREA_CLASS_ID)='TR'))GROUP BY DIPDLIB.DI842P.PROCESS_CYCLE_DATE, DIPDLIB.DI842P.ACTUAL_PICKER_ID, DIPDLIB.DI210P.AREA_CLASS_ID HAVING (((DIPDLIB.DI842P.PROCESS_CYCLE_DATE)=?) AND ((DIPDLIB.DI842P.ACTUAL_PICKER_ID) Like 'B%')) ORDER BY DIPDLIB.DI842P.ACTUAL_PICKER_ID"
    ...
    Private Sub ImportC()
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrImportC = "SELECT RF_TRANSACTION_DATE, USER_STAMP, COUNT(RF_TRANS_BAR_CODE) AS CountOfRF_TRANS_BAR_CODE FROM DIPDLIB.DI281P WHERE (RF_TRANSACTION_DATE = ?) AND ((RF_TRANSACTION_TYPE LIKE 'F') OR (RF_TRANSACTION_TYPE LIKE 'P')) AND (RF_TRANS_TO_LOCATION LIKE 'D%') GROUP BY USER_STAMP, RF_TRANSACTION_DATE HAVING (USER_STAMP <> ' ') ORDER BY USER_STAMP"
    ...
    Private Sub ImportR()
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrImportR = "SELECT RF_TRANSACTION_DATE, USER_STAMP, COUNT(RF_TRANS_BAR_CODE) AS CountOfRF_TRANS_BAR_CODE FROM DIPDLIB.DI281P WHERE (RF_TRANSACTION_DATE = ?) AND ((RF_TRANSACTION_TYPE LIKE 'F') OR (RF_TRANSACTION_TYPE LIKE 'P')) AND (RF_TRANS_TO_LOCATION NOT LIKE 'D%') GROUP BY USER_STAMP, RF_TRANSACTION_DATE HAVING (USER_STAMP <> ' ') ORDER BY USER_STAMP"
        ...
        Dim sqlStrFCS As String
        sqlStrFCS = "INSERT INTO Prod (DTE, M, D, Y, EmployeeID, Amount, Department, Shift, Function ) SELECT DateValue([M] & '/' & [D] & '/' & [Y]) AS [Date], Mid([FCPFCSImportTempTable].[RF_TRANSACTION_DATE],4,2) AS M, RIGHT([FCPFCSImportTempTable].[RF_TRANSACTION_DATE],2) AS D, Mid([FCPFCSImportTempTable].[RF_TRANSACTION_DATE],2,2) AS Y, FCPFCSImportTempTable.USER_STAMP, FCPFCSImportTempTable.CountOfRF_TRANS_BAR_CODE, 2 AS Department, 1 AS Shift, 'R' as Function FROM TMs INNER JOIN FCPFCSImportTempTable ON TMs.EmployeeID = FCPFCSImportTempTable.USER_STAMP WHERE (((TMs.DepartmentID)=2) AND ((TMs.ShiftID)=1)) ORDER BY FCPFCSImportTempTable.USER_STAMP"
    ...
    Protected Sub ImportButton_OnClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImportButton.Click
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        sqlStrFunction = "SELECT Count(Prod.DTE) AS CountOfDTE FROM Prod WHERE (Prod.DTE) = @Date AND (Prod.Shift)=1 AND (Prod.Department)=2"
        ...
        sqlStrCountImport = "SELECT Count(Prod.DTE) AS CountOfDTE FROM Prod WHERE (Prod.DTE) = @Date AND (Prod.Shift)=1 AND (Prod.Department)=2"
