<%@ Page Title="Edit Receiving 2nd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
    AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="REC_2nd_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="backToShift" runat="server" NavigateUrl="~/REC/2nd/Shift.aspx"
            ...
            <li>
                <asp:LinkButton ID="ImportProd" runat="server" PostBackUrl="~/REC/2nd/ImportTMProd.aspx"
                    onmouseover="window.status='Import Productivity';return true;" onmouseout="window.status=''; return true;"
                    CausesValidation="false">Import Productivity</asp:LinkButton><ajaxToolkit:ConfirmButtonExtender
                        ID="ImportConfirmButton" runat="server" TargetControlID="ImportProd" ConfirmText="Click OK only if you have verified the Team Members that worked on the Import Date.">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/REC/2nd/ViewbyTM.aspx"
                    onmouseover="window.status='View By Team Member';return true;" onmouseout="window.status=''; return true;">View by Team Member</asp:HyperLink>
            </li>
            <li>
                <asp:HyperLink ID="ViewByFunction" runat="server" NavigateUrl="~/REC/2nd/ViewbyFunct.aspx"
            ...
            <li>
                <asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/REC/2nd/SummDateRange.aspx"
            ...
            <li>
                <asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/REC/2nd/SummbyFunct.aspx"
    ...
    <div class="Form" id="Form">
        <div id="HeadDate">
            <h2>
                <asp:Label ID="EditLabel" runat="server" Text="Edit Receiving 2nd Shift Productivity"></asp:Label></h2>
            ...
            <asp:RequiredFieldValidator ID="DteValidator" runat="server" ErrorMessage="Date is a required field"
                ControlToValidate="DTE" Display="Dynamic"></asp:RequiredFieldValidator><asp:CompareValidator
                    ID="DateTypeValidator" runat="server" ErrorMessage="Must be in date format mm/dd/yy"
                    ControlToValidate="DTE" Operator="DataTypeCheck" Type="Date" Display="none"></asp:CompareValidator></div>
                        ...
                        <asp:TemplateField HeaderText="Hours" >
                            <ItemTemplate>
                                ...
                                <asp:CompareValidator ID="HoursValidator" runat="server" ErrorMessage="Hours must be greater than zero"
                                    ControlToValidate="Hours" Operator="NotEqual" ValueToCompare="0" Display="none"></asp:CompareValidator><asp:CompareValidator
                                        ID="HoursTypeValidator" runat="server" ErrorMessage="Must be a number" ControlToValidate="Hours"
                                        Operator="DataTypeCheck" Type="Double" Display="none"></asp:CompareValidator>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Amount" >
                            <ItemTemplate>
                                ...
                                <asp:CompareValidator ID="AmountValidator2" runat="server" ErrorMessage="Amount must whole number"
                                    ControlToValidate="Amount" Operator="GreaterThan" ValueToCompare="0.1" Display="None"></asp:CompareValidator><asp:CompareValidator
                                        ID="AmountTypeValidator" runat="server" ErrorMessage="Must be a number" ControlToValidate="Amount"
    ...
    <asp:SqlDataSource ID="TMListDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
...
FROM TMs WHERE (((TMs.DepartmentID)=1) AND ((TMs.ShiftID)=2)) ORDER BY TMS.LastName">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="GVFunctDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT DISTINCT Function, Description FROM Functions WHERE (Department = 1) ORDER BY Description">
    </asp:SqlDataSource>
</asp:Content>
