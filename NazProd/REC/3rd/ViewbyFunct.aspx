<%@ Page Title="Receiving 3rd Shift Productivity by Function" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ViewbyFunct.aspx.vb" Inherits="REC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <p class="floatRight">
    ...
    <h2>
        Receiving 3rd Shift Productivity by Function
    </h2>
...
<asp:Label ID="NoData" runat="server" Text="No Data to Display" Visible="false" CssClass="Red" ></asp:Label>
    ...
    <asp:SqlDataSource ID="DatesDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT DISTINCT DTE FROM PROD WHERE DTE Between ? And ? AND Shift=3 and Department =1">
        <SelectParameters>
...
WHERE (Prod.DTE BETWEEN ? AND ?) AND (Prod.Function=?) AND (Prod.Department = 1) AND (Prod.Shift = 3)">
        <SelectParameters>
