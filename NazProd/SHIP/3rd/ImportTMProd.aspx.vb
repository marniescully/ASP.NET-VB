...
Partial Class ImportTM
    ...
    Protected Sub ImportButton_OnClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImportButton.Click
        ...
        sqlStrCountImport = "SELECT Count(SHIPImportTempTable.USER_STAMP) AS CountOfUSER_STAMP FROM TMs INNER JOIN SHIPImportTempTable ON TMs.EmployeeID = SHIPImportTempTable.USER_STAMP GROUP BY TMs.DepartmentID, TMs.ShiftID HAVING(TMs.DepartmentID) = 4 And (TMs.ShiftID) = 3"
