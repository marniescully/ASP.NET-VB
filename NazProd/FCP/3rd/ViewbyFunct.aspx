<%@ Page Title="Full Case Pick 3rd Shift Productivity by Function" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ViewbyFunct.aspx.vb" Inherits="FCP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <p class="floatRight">
    ...
    <h2>
        Full Case Pick 3rd Shift Productivity by Function
    </h2>
...
<asp:SqlDataSource ID="FunctListDataSource" runat="server" 
     ...
     <asp:SqlDataSource ID="DatesDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT DISTINCT DTE FROM PROD WHERE DTE Between ? And ? AND Shift=3 and Department =2">
...
WHERE (Prod.DTE BETWEEN ? AND ?) AND (Prod.Function=?) AND (Prod.Department = 2) AND (Prod.Shift = 3)">
