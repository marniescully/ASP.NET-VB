<%@ Page Title="Edit Shipping 3rd Shift Productivity" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="SHIP_1st_Add" %>
...
<div id="sideNav">
 ...
 <h3>Tasks</h3>
    ...
    <li><asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/SHIP/3rd/SummDateRange.aspx" onmouseover="window.status='Summary of Date Range';return true;" onmouseout ="window.status=''; return true;">Summary of Date Range</asp:HyperLink> </li>
     <li><asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/SHIP/3rd/SummbyFunct.aspx" onmouseover="window.status='Summary by Function';return true;" onmouseout ="window.status=''; return true;" CausesValidation="false">Summary by Function</asp:LinkButton> 
  ...
  <div class="Form" id="Form">
    <div id="HeadDate">
       <h2><asp:Label ID="EditLabel" runat="server" Text="Edit Shipping 3rd Shift Productivity"></asp:Label></h2>
...
FROM TMs WHERE (((TMs.DepartmentID)=4) AND ((TMs.ShiftID)=3)) ORDER BY TMS.LastName"></asp:SqlDataSource>
