<%@ Page Title="Full Case Stock 3rd Shift Productivity Summary by Date Range " Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="SummDateRange.aspx.vb" Inherits="FCS" %>
...
<p class="floatRight">
    ...
    <h2>
        Full Case Stock 3rd Shift Productivity Summary by Date Range
    </h2>

  <div id="SearchReports">
        
                <asp:Label ID="FunctionLabel" runat="server">Function: &nbsp;</asp:Label>
         <asp:DropDownList ID="FunctList" runat="server" DataTextField="Description" DataValueField="Function" DataSourceID="FunctListDataSource"  Class="DropDownList" AppendDataBoundItems="true" >
...
<div class="AllRepeat"> 
    ...
    <asp:GridView ID="TMProd" runat="server" 
        AutoGenerateColumns="False" PageSize="20" ViewStateMode="Disabled" CssClass="DistFunctTable"  >
