<%@ Page Title="Import Shipping 1st Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="backToShift" runat="server" NavigateUrl="~/SHIP/1st/Shift.aspx"
            ...
            <li>
                <asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/SHIP/1st/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;"
        ...
        <ul>
            <li>
                <asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/SHIP/1st/ViewbyTM.aspx"
                    onmouseover="window.status='View By TM';return true;" onmouseout="window.status=''; return true;">View by Team Member</asp:HyperLink>
            </li>
            <li>
                <asp:HyperLink ID="ViewByFunction" runat="server" NavigateUrl="~/SHIP/1st/ViewbyFunct.aspx"
            ...
            <li>
                <asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/SHIP/1st/SummDateRange.aspx"
            ...
            <li>
                <asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/SHIP/1st/SummbyFunct.aspx"
   ...
   <p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        ...
        <h2>
            Import Shipping 1st Shift Productivity</h2>
