...
Partial Class ImportTM
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        Dim sqlStrLastDate = "SELECT Max(Prod.DTE) AS MaxOfDTE FROM PROD WHERE (((Prod.Department)=1) AND ((Prod.Shift)=2))"
    ...
    Protected Sub ImportButton_OnClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImportButton.Click
        ...
        sqlStrFunction = "SELECT Count(Prod.DTE) AS CountOfDTE FROM Prod WHERE (Prod.DTE) = @Date AND (Prod.Shift)=2 AND (Prod.Department)=1"
        ...
        sqlStrCountImport = "SELECT Count(RECImportTempTable.RECEIVER_EMPLOYEE_ID) AS CountOfRECEIVER_EMPLOYEE_ID FROM TMs INNER JOIN RECImportTempTable ON TMs.EmployeeID = RECImportTempTable.RECEIVER_EMPLOYEE_ID GROUP BY TMs.DepartmentID, TMs.ShiftID HAVING(TMs.DepartmentID) = 1 And (TMs.ShiftID) = 2"
