...
<div class="TMList" id="TMList">
 <asp:DetailsView ID="EditTMProd" runat="server"   
     ...
     <asp:SqlDataSource ID="EditTMProdDataSource" runat="server" 
        ...
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT TMs.EmployeeID, TMs.FirstName, TMs.LastName, Prod.DTE, Prod.MispickRFC, Prod.Unaccount, Prod.MispickStore, Functions.Description, Prod.Amount, Prod.Function, Prod.FunctHours, Prod.MiscHours, Prod.Coach, Prod.Step, Prod.Notes, Prod.Shift
...
UpdateCommand="UPDATE PROD SET PROD.Amount=?, PROD.FunctHours = ?, PROD.MiscHours = ?, PROD.MispickRFC = ?, PROD.MispickStore = ?, PROD.Unaccount = ?, PROD.Coach = ?, PROD.Step = ?, PROD.Notes = ? WHERE PROD.DTE = ? AND PROD.EmployeeID = ? AND PROD.Function = ? AND PROD.Department=2"
...
<SelectParameters>
 ...
 <UpdateParameters>
        ...
        <asp:Parameter Name="MispickRFC" DbType="Int32" />
        <asp:Parameter Name="MispickStore" DbType="Int32" />
        <asp:Parameter Name="Unaccount" DbType="Int32" />
        <asp:Parameter Name="Coach" DbType="String" />
        <asp:Parameter Name="Step" DbType="String" />
