<%@ Page Title="How to View Productivity of all Team Members by Function" Language="VB"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2>
        How to View Productivity of all Team Members by Function</h2>
    <div class="Tutorial" id="LeftColumn">
        <ol>
            <li >From your department's shift page click <span class="StrongEmphasis">
                View by Function</span> from the Reports list
                <br />
                <img  alt="Click View by Function Link" src="images/ClickViewbyFunct.jpg" />
            </li>
            ...
            <li >Choose the start date that you'd like to view by clicking
                ...
                <img  alt="Choose Start Date" src="images/ChooseFunctstart.jpg" />
            </li>
            <li >The end date is automatically the same date as the start
                ...
                <img alt="Choose End Date" src="images/ChooseFunctend.jpg" />
            </li>
            ...
            <li >The report based on your choices is displayed.
                <br />
                <img  alt="View by Function Report" src="images/ViewbyFunctReport.jpg" />
            </li>
