<%@ Page Title="Edit Full Case Stock 2nd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
    AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="FCS_2nd_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            ...
            <li>
                <asp:LinkButton ID="ImportProd" runat="server" PostBackUrl="~/FCS/2nd/ImportTMProd.aspx"
    ...
    <div id="HeadDate">
  <h2>
        <asp:Label ID="EditLabel" runat="server" Text="Edit Full Case Stock 2nd Shift Productivity"></asp:Label></h2>
            ...
            <asp:RequiredFieldValidator ID="DteValidator" runat="server" ErrorMessage="Date is a required field"
                ControlToValidate="DTE" Display="Dynamic"></asp:RequiredFieldValidator><asp:CompareValidator ID="DateTypeValidator" runat="server" ErrorMessage="Must be in date format mm/dd/yy" ControlToValidate="DTE" Operator="DataTypeCheck" Type="Date" Display="none"></asp:CompareValidator></div>
...
FROM TMs WHERE (((TMs.DepartmentID)=3) AND ((TMs.ShiftID)=2)) ORDER BY TMS.LastName">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="GVFunctDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT DISTINCT Function, Description FROM Functions WHERE (Department = 3) ORDER BY Description">
    </asp:SqlDataSource>
</asp:Content>
