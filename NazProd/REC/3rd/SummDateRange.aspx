<%@ Page Title="Receiving 3rd Shift Summary by Date Range" Language="VB" MasterPageFile="~/Site.master"
    AutoEventWireup="false" CodeFile="SummDateRange.aspx.vb" Inherits="REC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <p class="floatRight">
    ...
    <h2>
        Receiving 3rd Shift Productivity Summary by Date Range
    </h2>
  ...
  <div id="SearchReports">
        ...
        <asp:RequiredFieldValidator ID="StrtDteRequiredFieldValidator" runat="server" ErrorMessage="The Start Date is a Required field."
        ...
        <asp:RequiredFieldValidator ID="EndDteRequiredFieldValidator" runat="server" ErrorMessage="The End Date is a Required field."
        ...
        <ajaxToolkit:CalendarExtender ID="StrtDteCalendarExtender" TargetControlID="txtStartDate"
            runat="server">
        </ajaxToolkit:CalendarExtender>
        <ajaxToolkit:CalendarExtender ID="EndDteCalendarExtender" TargetControlID="txtEndDate"
            runat="server">
        </ajaxToolkit:CalendarExtender>
 ...
 <asp:GridView ID="TMProd" runat="server" 
        AutoGenerateColumns="False" ViewStateMode="Disabled" CssClass="DistFunctTable"
        PageSize="20">
