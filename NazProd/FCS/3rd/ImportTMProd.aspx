...
<div id="sideNav">
 ...
 <h3>Tasks</h3>
    <ul>
     ...
     <li><asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/FCS/3rd/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;" onmouseout ="window.status=''; return true;">Edit Productivity</asp:HyperLink> </li>
      
       </ul>
   
    <h3>Reports</h3>
        <ul>   
    <li><asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/FCS/3rd/ViewbyTM.aspx" CausesValidation="False" onmouseover="window.status='View By TM';return true;" onmouseout ="window.status=''; return true;">View by Team Member</asp:HyperLink> </li>
...
<p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        ...
        <h2>
            Import Full Case Stock 3rd Shift Productivity</h2>
