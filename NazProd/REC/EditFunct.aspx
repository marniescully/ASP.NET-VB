<%@ Page Title="Receiving Functions" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="EditFunct.aspx.vb" Inherits="REC_EditRECFunct" %>
...
<asp:Panel ID="SideNavigation" runat="server" >
 ...
 <h3>Shifts</h3>
    ...
    <li><asp:HyperLink ID="ThirdShift" runat="server" NavigateUrl="~/REC/3rd/Shift.aspx">3rd Shift</asp:HyperLink></li>
    ...
    <div id="LeftColumn" > 
<h2><asp:Label ID="FunctionLabel" runat="server" Text="Receiving Functions"></asp:Label></h2>

    <asp:GridView ID="RECFunct" runat="server" AllowSorting="True" 
        AutoGenerateColumns="False" DataKeyNames="Function" DataSourceID="RECFunctions">
...
<asp:DetailsView ID="EditFunct" runat="server" AutoGenerateRows="False" 
 ...
 <asp:SqlDataSource ID="RECFunctions" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT [Function], [Rate], [Description] FROM [Functions] WHERE Functions.Department = 1 ORDER BY [Function]"  >
     ...
     <asp:SqlDataSource ID="EditFunctDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
            SelectCommand="SELECT [Function], [Rate], [Description] FROM [Functions] WHERE ([Function] = ?) AND Functions.Department =1" 
            UpdateCommand="UPDATE [Functions] SET [Rate] = ?, [Description] = ? WHERE [Function] = ? AND Functions.Department = 1">
          
            <SelectParameters>
                <asp:ControlParameter ControlID="RECFunct" Name="?" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
