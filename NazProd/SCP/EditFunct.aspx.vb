...
Partial Class SCP_EditSCPFunct
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
           ...
           ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
            ...
            CountSqlString = "SELECT Count(Functions.Function) AS CountOfFunctions FROM Functions WHERE Functions.Department =8"
            ...
            Try
                ...
                If FunctCount = 0 Then
                    ...
                    FunctionLabel.Text = "Add a Split Case Pick Function"
                    AddFunction.Visible = True
                    SCPFunct.Visible = False
                ...
                Else
                    SCPFunct.DataSourceID = "SCPFunctions"
                    SCPFunct.DataBind()
                    FunctionLabel.Text = "Split Case Pick Functions"

                    SCPFunct.Visible = True
    ...
    Protected Sub SCSFunct_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles SCPFunct.RowCommand
    ...
    Protected Sub EditFunct_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewCommandEventArgs)
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        If e.CommandName = "DeleteThis" Then
            'Code to check whether function is in SCP productivity table if not then delete

            Dim DeleteSqlString As String
            DeleteSqlString = "DELETE FROM Functions WHERE (Function = @Function) AND (Department=8) "

            Dim sqlStrFunction As String
            sqlStrFunction = "SELECT Count(PROD.Function) AS CountOfFunction FROM PROD WHERE (PROD.Function) = @Function AND (PROD.DEPARTMENT=8)"
    ...
    Protected Sub AddFunction_ItemInserting(ByVal sender As Object, _
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        Dim sqlStrFunction As String
        sqlStrFunction = "SELECT Count(Functions.Function) AS CountOfFunction FROM Functions WHERE (Functions.Function) = @Function AND (Functions.Department=8)"
