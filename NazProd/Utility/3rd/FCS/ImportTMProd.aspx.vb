...
Partial Class ImportTM
    ...
    Protected Sub ImportButton_OnClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImportButton.Click
        ...
        sqlStrCountImport = "SELECT Count(FCSImportTempTable.USER_STAMP) AS CountOfUSER_STAMP FROM TMs INNER JOIN FCSImportTempTable ON TMs.EmployeeID = FCSImportTempTable.USER_STAMP GROUP BY TMs.DepartmentID, TMs.ShiftID HAVING (TMs.DepartmentID)=5 AND (TMs.ShiftID)=3"
