...
Partial Class FCP_EditFCPFunct
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
           ...
           ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
            ...
            CountSqlString = "SELECT Count(Functions.Function) AS CountOfFunctions FROM Functions WHERE Functions.Department =2"
            ...
            Try
                ...
                If FunctCount = 0 Then
                    ...
                    FunctionLabel.Text = "Add a Full Case Pick Function"
                    AddFunction.Visible = True
                    FCPFunct.Visible = False
                ...
                Else
                    FCPFunct.DataSourceID = "FCPFunctions"
                    FCPFunct.DataBind()
                    FunctionLabel.Text = "Full Case Pick Functions"

                    FCPFunct.Visible = True
    ...
    Protected Sub FCPFunct_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FCPFunct.RowCommand
    ...
    Protected Sub EditFunct_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewCommandEventArgs)
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        If e.CommandName = "DeleteThis" Then
            ...
            DeleteSqlString = "DELETE FROM Functions WHERE (Function = @Function) AND (Department=2) "

            Dim sqlStrFunction As String
            sqlStrFunction = "SELECT Count(PROD.Function) AS CountOfFunction FROM PROD WHERE (PROD.Function) = @Function AND (PROD.DEPARTMENT=2)"
    ...
    Protected Sub AddFunction_ItemInserting(ByVal sender As Object, _
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        Dim sqlStrFunction As String
        sqlStrFunction = "SELECT Count(Functions.Function) AS CountOfFunction FROM Functions WHERE (Functions.Function) = @Function AND (Functions.Department=2)"
