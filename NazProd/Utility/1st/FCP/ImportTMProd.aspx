<%@ Page Title="Import Utility Full Case Pick 1st Shift Productivity" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ImportTMProd.aspx.vb" Inherits="ImportTM" %>
...
<div id="sideNav" class="sideNav">
 ...
 <h3>
    ...
    <li><asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/FCP/1st/SummDateRange.aspx" onmouseover="window.status='Summary of Date Range';return true;" onmouseout ="window.status=''; return true;">Summary of Date Range</asp:HyperLink> </li>
     <li><asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/FCP/1st/SummbyFunct.aspx" onmouseover="window.status='Summary by Function';return true;" onmouseout ="window.status=''; return true;"  CausesValidation="false">Summary by Function</asp:LinkButton> 
  ...
  <h2>Import Utility Full Case Pick 1st Shift Productivity</h2>
