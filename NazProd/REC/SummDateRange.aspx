<%@ Page Title="Receiving Summary by Date Range" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="SummDateRange.aspx.vb" Inherits="REC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <p class="floatRight">
    <asp:HyperLink ID="backToShiftLink" runat="server" NavigateUrl="~/REC.aspx">Back to Receiving</asp:HyperLink>
    </p>
 
    <h2>
        Receiving Productivity Summary by Date Range
    </h2>
  ...
  <div id="SearchReports">
         ...
         <asp:DropDownList ID="FunctList" runat="server"   DataTextField="Description" DataValueField="Function"  DataSourceID="FunctListDataSource" AppendDataBoundItems="true"  Class="DropDownList" >
    <asp:ListItem Value="All" Selected="True">All </asp:ListItem>
           ...
           <asp:RequiredFieldValidator ID="StrtDteRequiredFieldValidator" runat="server" ErrorMessage="The Start Date is a Required field." ControlToValidate="txtStartDate" Display="None" ></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="EndDteRequiredFieldValidator" runat="server" ErrorMessage="The End Date is a Required field."  ControlToValidate="txtEndDate" Display="None" ></asp:RequiredFieldValidator>
         <asp:CompareValidator ID="dateCheck" runat="server" ErrorMessage="End Date must be after Start Date" ControlToCompare="txtStartDate" ControlToValidate="txtEndDate" Operator="GreaterThanEqual" Type="Date" Display="None"  ></asp:CompareValidator>
           <ajaxToolkit:CalendarExtender ID="StrtDteCalendarExtender" TargetControlID="txtStartDate" runat="server"> </ajaxToolkit:CalendarExtender>
                      <ajaxToolkit:CalendarExtender ID="EndDteCalendarExtender" TargetControlID="txtEndDate" runat="server">  </ajaxToolkit:CalendarExtender>
              ...
              <asp:LinkButton ID="ClearSearchButton" runat="server" OnClick="ClearSearchButton_OnClick"  Visible="true" Text="Reset" CausesValidation="false"></asp:LinkButton>
               ...
               <asp:ValidationSummary ID="ValidationSummary"  runat="server" />         </div>    
...
<div class="AllRepeat"> 
 ...
 <asp:GridView ID="TMProd" runat="server" 
       ...
       <asp:SqlDataSource ID="FunctListDataSource" runat="server" 
        ...
        SelectCommand="SELECT Function, Description FROM Functions WHERE Functions.Department=1 Order by Description">
     </asp:SqlDataSource>
    </asp:Content>
