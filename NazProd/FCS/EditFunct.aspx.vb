...
Partial Class FCS_EditFCSFunct
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
           ...
           ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
            ...
            CountSqlString = "SELECT Count(Functions.Function) AS CountOfFunctions FROM Functions WHERE Functions.Department =3"
            ...
            Try
                ...
                If FunctCount = 0 Then
                    ...
                    FunctionLabel.Text = "Add a Full Case Stock Function"
                    AddFunction.Visible = True
                    FCSFunct.Visible = False
                ...
                Else
                    FCSFunct.DataSourceID = "FCSFunctions"
                    FCSFunct.DataBind()
                    FunctionLabel.Text = "Full Case Stock Functions"

                    FCSFunct.Visible = True
    ...
    Protected Sub FCSFunct_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FCSFunct.RowCommand
    ...
    Protected Sub EditFunct_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewCommandEventArgs)
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        If e.CommandName = "DeleteThis" Then
            ...
            DeleteSqlString = "DELETE FROM Functions WHERE (Function = @Function) AND (Department=3) "

            Dim sqlStrFunction As String
            sqlStrFunction = "SELECT Count(PROD.Function) AS CountOfFunction FROM PROD WHERE (PROD.Function) = @Function AND (PROD.DEPARTMENT=3)"
    ...
    Protected Sub AddFunction_ItemInserting(ByVal sender As Object, _
       ...
       ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
        ...
        Dim sqlStrFunction As String
        sqlStrFunction = "SELECT Count(Functions.Function) AS CountOfFunction FROM Functions WHERE (Functions.Function) = @Function AND (Functions.Department=3)"
        ...
        FCSFunct.DataSourceID = "FCSPFunctions"
        FCSFunct.DataBind()
        FunctionLabel.Text = "Full Case Stock Functions"
