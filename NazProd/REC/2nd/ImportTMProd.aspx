<%@ Page Title="Import Receiving 2nd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            ...
            <li>
                <asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/REC/2nd/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;"
    ...
    <p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        ...
        <h2>
            Import Receiving 2nd Shift Productivity</h2>
