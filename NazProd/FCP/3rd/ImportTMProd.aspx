<%@ Page Title="Import Full Case Pick 3rd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            ...
            <li>
                <asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/FCP/3rd/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;"
...
<p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        <h2>
            Import Full Case Pick 3rd Shift Productivity</h2>
