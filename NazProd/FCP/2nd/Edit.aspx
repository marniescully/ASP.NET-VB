<%@ Page Title="Edit Full Case Pick 2nd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
    AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="FCP_2nd_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="backToShift" runat="server" NavigateUrl="~/FCP/2nd/Shift.aspx"
            ...
            <li>
                <asp:LinkButton ID="ImportProd" runat="server" PostBackUrl="~/FCP/2nd/ImportTMProd.aspx"
        ...
        <ul>
            <li>
                <asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/FCP/2nd/ViewbyTM.aspx"
            ...
            <li>
                <asp:HyperLink ID="ViewByFunction" runat="server" NavigateUrl="~/FCP/2nd/ViewbyFunct.aspx"
            ...
            <li>
                <asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/FCP/2nd/SummDateRange.aspx"
            ...
            <li>
                <asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/FCP/2nd/SummbyFunct.aspx"
    ...
    <div id="Form" class="Form">
        <div id="HeadDate">
            <h2>
                <asp:Label ID="EditLabel" runat="server" Text="Edit Full Case Pick 2nd Shift Productivity"></asp:Label></h2>
...
FROM TMs WHERE (((TMs.DepartmentID)=2) AND ((TMs.ShiftID)=2)) ORDER BY TMS.LastName">
    </asp:SqlDataSource>
