<%@ Page Title="Import Shipping 3rd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="backToShift" runat="server" NavigateUrl="~/SHIP/3rd/Shift.aspx"
            ...
            <li>
                <asp:HyperLink ID="EditProd" runat="server" NavigateUrl="~/SHIP/3rd/Edit.aspx" onmouseover="window.status='Edit Productivity';return true;"
        ...
        <ul>
            <li>
                <asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/SHIP/3rd/ViewbyTM.aspx"
                    onmouseover="window.status='View By TM';return true;" onmouseout="window.status=''; return true;">View by Team Member</asp:HyperLink>
            </li>
            <li>
                <asp:HyperLink ID="ViewByFunction" runat="server" NavigateUrl="~/SHIP/3rd/ViewbyFunct.aspx"
            ...
            <li>
                <asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/SHIP/3rd/SummDateRange.aspx"
            ...
            <li>
                <asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/SHIP/3rd/SummbyFunct.aspx"
   ...
   <p class="floatRight"><asp:Label ID="LastDateImport" runat="server" Text=""></asp:Label></p>
        ...
        <h2>
            Import Shipping 3rd Shift Productivity</h2>
