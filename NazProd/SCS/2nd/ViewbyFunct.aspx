<%@ Page Title="Split Case Stock 2nd Shift Productivity by Function" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ViewbyFunct.aspx.vb" Inherits="SCS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h2>
        Split Case Stock 2nd Shift Productivity by Function
    </h2>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:GridView ID="TMProd" runat="server" AutoGenerateColumns="False" PageSize="20"
                                    OnRowDataBound="TMProd_RowDataBound" ShowFooter="True" DataKeyNames="DTE,EmployeeID,Function"
                                    ViewStateMode="Disabled" class="DistFunctTable">
                                    <AlternatingRowStyle BackColor="#F2F2F2" />
                                    <Columns>
                                        <asp:BoundField DataField="FullName" HeaderText="" SortExpression="FullName" />
...
<asp:SqlDataSource ID="FunctListDataSource" runat="server" 
     ...
     <asp:SqlDataSource ID="DatesDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT DISTINCT DTE FROM PROD WHERE DTE Between ? And ? AND Shift=2 and Department =9">
...
WHERE (Prod.DTE BETWEEN ? AND ?) AND (Prod.Function=?) AND (Prod.Department = 9) AND (Prod.Shift = 2)">
