...
Partial Class ImportTM
    ...
    Protected Sub ImportButton_OnClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImportButton.Click
        ...
        sqlStrCountImport = "SELECT Count(RECImportTempTable.RECEIVER_EMPLOYEE_ID) AS CountOfRECEIVER_EMPLOYEE_ID FROM TMs INNER JOIN RECImportTempTable ON TMs.EmployeeID = RECImportTempTable.RECEIVER_EMPLOYEE_ID GROUP BY TMs.DepartmentID, TMs.ShiftID HAVING(TMs.DepartmentID) = 5 And (TMs.ShiftID) = 2"
