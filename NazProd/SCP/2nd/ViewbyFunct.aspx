<%@ Page Title="Split Case Pick 2nd Shift Productivity by Function" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ViewbyFunct.aspx.vb" Inherits="FCP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <p class="floatRight">
    ...
    <h2>
        Split Case Pick 2nd Shift Productivity by Function
    </h2>
...
<asp:SqlDataSource ID="FunctListDataSource" runat="server" 
     ...
     <asp:SqlDataSource ID="DatesDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT DISTINCT DTE FROM PROD WHERE DTE Between ? And ? AND Shift=2 and Department =8">
...
WHERE (Prod.DTE BETWEEN ? AND ?) AND (Prod.Function=?) AND (Prod.Department =8) AND (Prod.Shift = 2)">
