...
<p class="floatRight">
    <asp:HyperLink ID="backToShiftLink" runat="server" NavigateUrl="~/FCP.aspx">Back to Full Case Pick</asp:HyperLink>
    </p>
 
    <h2>
        Full Case Pick Productivity Summary by Function
    </h2>
