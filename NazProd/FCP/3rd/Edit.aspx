<%@ Page Title="Edit Full Case Pick 3rd Shift Productivity" Language="VB" MasterPageFile="~/Site.master"
    AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="FCP_3rd_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="sideNav">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="backToShift" runat="server" NavigateUrl="~/FCP/3rd/Shift.aspx"
            ...
            <li>
                <asp:LinkButton ID="ImportProd" runat="server" PostBackUrl="~/FCP/3rd/ImportTMProd.aspx"
        ...
        <ul>
            <li>
                <asp:HyperLink ID="ViewByTM" runat="server" NavigateUrl="~/FCP/3rd/ViewbyTM.aspx"
            ...
            <li>
                <asp:HyperLink ID="ViewByFunction" runat="server" NavigateUrl="~/FCP/3rd/ViewbyFunct.aspx"
            ...
            <li>
                <asp:HyperLink ID="SummaryDateRange" runat="server" NavigateUrl="~/FCP/3rd/SummDateRange.aspx"
            ...
            <li>
                <asp:LinkButton ID="SummbyFunct" runat="server" PostBackUrl="~/FCP/3rd/SummbyFunct.aspx"
    ...
    <div id="Form" class="Form">
        <div id="HeadDate">
            <h2>
                <asp:Label ID="EditLabel" runat="server" Text="Edit Full Case Pick 3rd Shift Productivity"></asp:Label></h2>
...
FROM TMs WHERE (((TMs.DepartmentID)=2) AND ((TMs.ShiftID)=3)) ORDER BY TMS.LastName">
    </asp:SqlDataSource>
