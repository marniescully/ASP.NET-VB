    ...
    Protected Sub AddTMProd_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewCommandEventArgs)
        ...
        If e.CommandName = "Add" Then
           ...
           ConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
            ...
            InsertSqlString = "INSERT INTO Prod (DTE, EmployeeID, Function, Department, Shift, Amount, FunctHours, MiscHours, MispickRFC, MispickStore, Unaccount, Coach, Step, Notes) VALUES (@DTE,@EmployeeID,@Function,@Dept,@Shift, @Amount,@FunctHours,@MiscHours,@MispickRFC,@MispickStore,@Unaccount,@Coach,@Steps,@Notes)"
